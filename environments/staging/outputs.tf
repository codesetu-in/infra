...
output "acr_login_server" {
  description = "ACR login server for CI/CD image push (set as STAGING_ACR_LOGIN_SERVER in GitHub vars)"
...
output "platform_identity_client_id" {
  description = "Managed identity client ID — set as AZURE_CLIENT_ID in GitHub Environment secrets"
